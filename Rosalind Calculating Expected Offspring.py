...
def expected_offspring(counts):
    proportions = np.array([1.0, 1.0, 1.0, 0.75, 0.5, 0.0])
    offspring = 2 * np.dot(counts, proportions)
    return offspring

#test = np.array([, , , , , ])
test = np.array([17459, 18682, 19967, 16566, 18787, 17171])
print('The number of offspring is: ')
print(expected_offspring(test))
